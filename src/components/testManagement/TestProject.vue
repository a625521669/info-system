  ...
  <div class="testProject">
      ...
      <el-row>
        <el-col :span="4">
          <div class="grid-content bg-purple">
            <el-input placeholder="请输入方案ID名称" icon="search" v-model="input">
            </el-input>
          </div>
        </el-col>
        <el-col :span="20">
    ...
    <div id="table">
      <el-table :data="tableData" stripe style="width: 100%">
        <el-table-column prop="id" label="测试ID">
        </el-table-column>
        <el-table-column prop="testName" label="测试名称">
        </el-table-column>
        <el-table-column prop="types" label="全部类型">
        </el-table-column>
        <el-table-column prop="testUser" label="测试用户，流量" width=140>
        </el-table-column>
        <el-table-column prop="projectID" label="方案ID，名称，流量" width=180>
        </el-table-column>
